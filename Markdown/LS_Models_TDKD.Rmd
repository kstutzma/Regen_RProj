...
- **Treat_Type** - treatment type (1m^2^)
...
### Pairwise with treatment type
```{r}
emmeans(so.ls4, specs = pairwise ~ Treat_Type, adjust = 'Tukey', type = 'response')
```
I think this advocates for mowing, which makes sense
...
plot_model(so.ls4, 
                       ...
                       axis.title = c("Other small seedling counts (log transformed)", "Total Count of Pitch Pine"),
...
plot_model(so.ls4, 
                       type = 'pred', 
                       terms = c('l.other', 'Treat_Type'),
                       axis.title = c("Total Basal Area per 10m^2^ (log transformed)", "Total Count of Shrub Oak"),
                       title = "Predicted Counts of Shrub Oak \n Seedlings >/=50cm & <2.5cm DBH",
           legend.title = "Treatment Type",
           line.size = 1,
           value.offset = 'Treat_Type',
...
# LS SO plot 4 ------------------- l.veg total vs. TT
plot_model(so.ls4, 
                       type = 'pred', 
                       terms = c('l.Veg_Total', 'Treat_Type'),
                       axis.title = c("Average Understory Vegetation Cover (log transformed)", "Total Count of Shrub Oak"),
                       title = "Predicted Counts of Shrub Oak \n Seedlings >/=50cm & <2.5cm DBH",
           legend.title = "Treatment Type",
           line.size = 1,
           value.offset = 'Treat_Type',
...
### Plot 4 is funny, because they make up the understory, so of course as it increases, so do they. Probably drop due to collinearity
