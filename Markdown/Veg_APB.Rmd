...
sig.apb_spp.scrs[3,5] <- "Virginia creeper"
sig.apb_spp.scrs[1,5] <- "Raspberry spp."
#sig.apb_spp.scrs[4,5] <- "Huckleberry"
sig.apb_spp.scrs[4,5] <- "Smooth sumac"
sig.apb_spp.scrs[5,5] <- "Arrowwood viburnum"
sig.apb_spp.scrs[6,5] <- "Enchanter's-nightshade"
sig.apb_spp.scrs[7,5] <- "Canada mayflower"
sig.apb_spp.scrs[9,5] <- "Glossy buckthorn"
sig.apb_spp.scrs[10,5] <- "Sarsaparilla"
sig.apb_spp.scrs[8,5] <- "Dogwood spp."
...
apb.nmds.plot <-  ggplot(apb.site.scrs, aes(x=NMDS1, y=NMDS2))+
  ...
  theme(legend.position = "right", legend.text = element_text(size = 14), legend.title = element_text(size = 14), axis.text = element_text(size = 14), axis.title = element_text(size = 16))
...
apb.nmds.plot +
  ...
  ggrepel::geom_text_repel(data = sig.apb_spp.scrs, aes(x=NMDS1, y=NMDS2, label = common, size = wt), cex = 3, direction = "both", segment.size = 0.25)+
