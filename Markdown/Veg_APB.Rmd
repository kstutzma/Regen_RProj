---
title: "NMDS on understory veg data for APB"
...
# In NH/ME - no KAAN, QUAL

# For this data set , 5% is ~6 plots:
# Would add: FRSP, LOSP, SORU, VIDE, COAM, CICA, SOUN1, MICA, COSP, FRAL, ARNU, LUPE, AMSP, RHHI, SOUN2
# If I stuck to at least 6, would lose: GAPR, PIST, LYBO
...
apb_2d <- metaMDS(rel_apb5, 
                   ...
                   trymax = 20,
                   autotransform = FALSE)
# this works and yields stress values of 0.12 - 0.35
...
### Ellipse - there is some problem in rendering this, though I can run it in R
```{r, eval=FALSE}
