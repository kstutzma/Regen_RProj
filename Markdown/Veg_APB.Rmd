...
tst.plot.e <- gg_ordiplot(ctrtst_2D, groups = ctrtst.meta$Treat_Type)
...
# I get a warning for this. Ran a test of everything without control and this warning didn't come up. I think it is due to the fact that there are only 2 control plots and so not enough data technically for a ellipse. Not sure what to do
