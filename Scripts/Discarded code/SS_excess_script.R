# Small Seedling excess script
# this is script from my first pass through of averaging my data; i've since changed tactics, but in case this code comes in handy, i've moved it here
#  2023-10-26
